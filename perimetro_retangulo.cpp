...
//constantes
const int lados = 4;
const double conversao = 0.01;

int main(){
    //Coletando as medias do retângulo
    ...
    cout<<"perimetro do retangulo em cm: "<<perimetro<<"\n";
    cout<<"Perimetro do retangulo em M: "<<perimetro * conversao<<"\n";
    return 0;
}
